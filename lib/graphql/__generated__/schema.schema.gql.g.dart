...
const Gconflict_action _$gconflictActionignore =
    const Gconflict_action._('ignore');
const Gconflict_action _$gconflictActionGupdate =
    const Gconflict_action._('Gupdate');

Gconflict_action _$gconflictActionValueOf(String name) {
  switch (name) {
    case 'ignore':
      return _$gconflictActionignore;
    case 'Gupdate':
      return _$gconflictActionGupdate;
    default:
      throw new ArgumentError(name);
  }
}

final BuiltSet<Gconflict_action> _$gconflictActionValues =
    new BuiltSet<Gconflict_action>(const <Gconflict_action>[
  _$gconflictActionignore,
  _$gconflictActionGupdate,
]);
...
const Gusers_select_column _$gusersSelectColumnrocket =
    const Gusers_select_column._('rocket');
const Gusers_select_column _$gusersSelectColumntimestamp =
    const Gusers_select_column._('timestamp');
const Gusers_select_column _$gusersSelectColumntwitter =
    const Gusers_select_column._('twitter');
...
Gusers_select_column _$gusersSelectColumnValueOf(String name) {
  switch (name) {
    ...
    case 'rocket':
      return _$gusersSelectColumnrocket;
    case 'timestamp':
      return _$gusersSelectColumntimestamp;
    case 'twitter':
      return _$gusersSelectColumntwitter;
    default:
      throw new ArgumentError(name);
  }
}
...
final BuiltSet<Gusers_select_column> _$gusersSelectColumnValues =
  ...
  _$gusersSelectColumnrocket,
  _$gusersSelectColumntimestamp,
  _$gusersSelectColumntwitter,
]);
...
const Gusers_update_column _$gusersUpdateColumnrocket =
    const Gusers_update_column._('rocket');
const Gusers_update_column _$gusersUpdateColumntimestamp =
    const Gusers_update_column._('timestamp');
const Gusers_update_column _$gusersUpdateColumntwitter =
    const Gusers_update_column._('twitter');
...
Gusers_update_column _$gusersUpdateColumnValueOf(String name) {
  switch (name) {
    ...
    case 'rocket':
      return _$gusersUpdateColumnrocket;
    case 'timestamp':
      return _$gusersUpdateColumntimestamp;
    case 'twitter':
      return _$gusersUpdateColumntwitter;
    default:
      throw new ArgumentError(name);
  }
}
...
final BuiltSet<Gusers_update_column> _$gusersUpdateColumnValues =
  ...
  _$gusersUpdateColumnrocket,
  _$gusersUpdateColumntimestamp,
  _$gusersUpdateColumntwitter,
]);
...
Serializer<Gconflict_action> _$gconflictActionSerializer =
    new _$Gconflict_actionSerializer();
...
class _$Gconflict_actionSerializer
    implements PrimitiveSerializer<Gconflict_action> {
  ...
  @override
  final Iterable<Type> types = const <Type>[Gconflict_action];
  @override
  final String wireName = 'Gconflict_action';

  @override
  Object serialize(Serializers serializers, Gconflict_action object,
          {FullType specifiedType = FullType.unspecified}) =>
      _toWire[object.name] ?? object.name;

  @override
  Gconflict_action deserialize(Serializers serializers, Object serialized,
          {FullType specifiedType = FullType.unspecified}) =>
      Gconflict_action.valueOf(
  ...
  Iterable<Object?> serialize(Serializers serializers, Gusers_bool_exp object,
    ...
    if (value != null) {
      result
        ...
        ..add(serializers.serialize(value,
            specifiedType: const FullType(
                BuiltList, const [const FullType.nullable(Gusers_bool_exp)])));
    }
    value = object.G_not;
    if (value != null) {
      result
        ...
        case '_and':
          result.G_and.replace(serializers.deserialize(value,
              specifiedType: const FullType(BuiltList, const [
                const FullType.nullable(Gusers_bool_exp)
              ]))! as BuiltList<Object?>);
          break;
        case '_not':
...
class _$GCapsulesFind extends GCapsulesFind {
  ...
  factory _$GCapsulesFind([void Function(GCapsulesFindBuilder)? updates]) =>
      (new GCapsulesFindBuilder()..update(updates))._build();
  ...
  int get hashCode {
    ...
    _$hash = $jc(_$hash, landings.hashCode);
    _$hash = $jc(_$hash, mission.hashCode);
    _$hash = $jc(_$hash, original_launch.hashCode);
    _$hash = $jc(_$hash, reuse_count.hashCode);
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'GCapsulesFind')
          ..add('id', id)
...
class GCapsulesFindBuilder
  ...
  @override
  GCapsulesFind build() => _build();

  _$GCapsulesFind _build() {
    ...
    try {
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'GCapsulesFind', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
...
class _$GCoresFind extends GCoresFind {
  ...
  factory _$GCoresFind([void Function(GCoresFindBuilder)? updates]) =>
      (new GCoresFindBuilder()..update(updates))._build();
  ...
  int get hashCode {
    var _$hash = 0;
    _$hash = $jc(_$hash, asds_attempts.hashCode);
    _$hash = $jc(_$hash, asds_landings.hashCode);
    _$hash = $jc(_$hash, block.hashCode);
    _$hash = $jc(_$hash, id.hashCode);
    _$hash = $jc(_$hash, missions.hashCode);
    _$hash = $jc(_$hash, original_launch.hashCode);
    _$hash = $jc(_$hash, reuse_count.hashCode);
    _$hash = $jc(_$hash, rtls_attempts.hashCode);
    _$hash = $jc(_$hash, rtls_landings.hashCode);
    _$hash = $jc(_$hash, status.hashCode);
    _$hash = $jc(_$hash, water_landing.hashCode);
    _$hash = $jf(_$hash);
    return _$hash;
  }
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'GCoresFind')
  ...
  _$GCoresFind _build() {
    ...
    try {
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'GCoresFind', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
...
class _$GHistoryFind extends GHistoryFind {
  ...
  factory _$GHistoryFind([void Function(GHistoryFindBuilder)? updates]) =>
      (new GHistoryFindBuilder()..update(updates))._build();
  ...
  int get hashCode {
    ...
    _$hash = $jc(_$hash, flight_number.hashCode);
    _$hash = $jc(_$hash, id.hashCode);
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'GHistoryFind')
          ..add('end', end)
...
class GHistoryFindBuilder
  ...
  @override
  GHistoryFind build() => _build();

  _$GHistoryFind _build() {
    ...
    try {
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'GHistoryFind', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
...
class _$GLaunchFind extends GLaunchFind {
  ...
  factory _$GLaunchFind([void Function(GLaunchFindBuilder)? updates]) =>
      (new GLaunchFindBuilder()..update(updates))._build();
  ...
  int get hashCode {
    var _$hash = 0;
    _$hash = $jc(_$hash, apoapsis_km.hashCode);
    _$hash = $jc(_$hash, block.hashCode);
    _$hash = $jc(_$hash, cap_serial.hashCode);
    _$hash = $jc(_$hash, capsule_reuse.hashCode);
    _$hash = $jc(_$hash, core_flight.hashCode);
    _$hash = $jc(_$hash, core_reuse.hashCode);
    _$hash = $jc(_$hash, core_serial.hashCode);
    _$hash = $jc(_$hash, customer.hashCode);
    _$hash = $jc(_$hash, eccentricity.hashCode);
    _$hash = $jc(_$hash, end.hashCode);
    _$hash = $jc(_$hash, epoch.hashCode);
    _$hash = $jc(_$hash, fairings_recovered.hashCode);
    _$hash = $jc(_$hash, fairings_recovery_attempt.hashCode);
    _$hash = $jc(_$hash, fairings_reuse.hashCode);
    _$hash = $jc(_$hash, fairings_reused.hashCode);
    _$hash = $jc(_$hash, fairings_ship.hashCode);
    _$hash = $jc(_$hash, gridfins.hashCode);
    _$hash = $jc(_$hash, id.hashCode);
    _$hash = $jc(_$hash, inclination_deg.hashCode);
    _$hash = $jc(_$hash, land_success.hashCode);
    _$hash = $jc(_$hash, landing_intent.hashCode);
    _$hash = $jc(_$hash, landing_type.hashCode);
    _$hash = $jc(_$hash, landing_vehicle.hashCode);
    _$hash = $jc(_$hash, launch_date_local.hashCode);
    _$hash = $jc(_$hash, launch_date_utc.hashCode);
    _$hash = $jc(_$hash, launch_success.hashCode);
    _$hash = $jc(_$hash, launch_year.hashCode);
    _$hash = $jc(_$hash, legs.hashCode);
    _$hash = $jc(_$hash, lifespan_years.hashCode);
    _$hash = $jc(_$hash, longitude.hashCode);
    _$hash = $jc(_$hash, manufacturer.hashCode);
    _$hash = $jc(_$hash, mean_motion.hashCode);
    _$hash = $jc(_$hash, mission_id.hashCode);
    _$hash = $jc(_$hash, mission_name.hashCode);
    _$hash = $jc(_$hash, nationality.hashCode);
    _$hash = $jc(_$hash, norad_id.hashCode);
    _$hash = $jc(_$hash, orbit.hashCode);
    _$hash = $jc(_$hash, payload_id.hashCode);
    _$hash = $jc(_$hash, payload_type.hashCode);
    _$hash = $jc(_$hash, periapsis_km.hashCode);
    _$hash = $jc(_$hash, period_min.hashCode);
    _$hash = $jc(_$hash, raan.hashCode);
    _$hash = $jc(_$hash, reference_system.hashCode);
    _$hash = $jc(_$hash, regime.hashCode);
    _$hash = $jc(_$hash, reused.hashCode);
    _$hash = $jc(_$hash, rocket_id.hashCode);
    _$hash = $jc(_$hash, rocket_name.hashCode);
    _$hash = $jc(_$hash, rocket_type.hashCode);
    _$hash = $jc(_$hash, second_stage_block.hashCode);
    _$hash = $jc(_$hash, semi_major_axis_km.hashCode);
    _$hash = $jc(_$hash, ship.hashCode);
    _$hash = $jc(_$hash, side_core1_reuse.hashCode);
    _$hash = $jc(_$hash, side_core2_reuse.hashCode);
    _$hash = $jc(_$hash, site_id.hashCode);
    _$hash = $jc(_$hash, site_name_long.hashCode);
    _$hash = $jc(_$hash, site_name.hashCode);
    _$hash = $jc(_$hash, start.hashCode);
    _$hash = $jc(_$hash, tbd.hashCode);
    _$hash = $jc(_$hash, tentative_max_precision.hashCode);
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'GLaunchFind')
...
class GLaunchFindBuilder implements Builder<GLaunchFind, GLaunchFindBuilder> {
  ...
  @override
  GLaunchFind build() => _build();

  _$GLaunchFind _build() {
    ...
    try {
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'GLaunchFind', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
...
class _$GMissionsFind extends GMissionsFind {
  ...
  factory _$GMissionsFind([void Function(GMissionsFindBuilder)? updates]) =>
      (new GMissionsFindBuilder()..update(updates))._build();
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'GMissionsFind')
          ..add('id', id)
          ..add('manufacturer', manufacturer)
          ..add('name', name)
          ..add('payload_id', payload_id))
...
class GMissionsFindBuilder
  ...
  @override
  GMissionsFind build() => _build();

  _$GMissionsFind _build() {
    final _$result = _$v ??
...
class _$GPayloadsFind extends GPayloadsFind {
  ...
  factory _$GPayloadsFind([void Function(GPayloadsFindBuilder)? updates]) =>
      (new GPayloadsFindBuilder()..update(updates))._build();
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'GPayloadsFind')
          ..add('apoapsis_km', apoapsis_km)
          ..add('customer', customer)
          ..add('eccentricity', eccentricity)
          ..add('epoch', epoch)
...
class GPayloadsFindBuilder
  ...
  @override
  GPayloadsFind build() => _build();

  _$GPayloadsFind _build() {
    ...
    try {
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'GPayloadsFind', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
...
class _$GShipsFind extends GShipsFind {
  ...
  factory _$GShipsFind([void Function(GShipsFindBuilder)? updates]) =>
      (new GShipsFindBuilder()..update(updates))._build();
  ...
  int get hashCode {
    ...
    _$hash = $jc(_$hash, imo.hashCode);
    _$hash = $jc(_$hash, mmsi.hashCode);
    _$hash = $jc(_$hash, abs.hashCode);
    _$hash = $jc(_$hash, Gclass.hashCode);
    _$hash = $jc(_$hash, weight_lbs.hashCode);
    _$hash = $jc(_$hash, weight_kg.hashCode);
    _$hash = $jc(_$hash, year_built.hashCode);
    _$hash = $jc(_$hash, home_port.hashCode);
    _$hash = $jc(_$hash, status.hashCode);
    _$hash = $jc(_$hash, speed_kn.hashCode);
    _$hash = $jc(_$hash, course_deg.hashCode);
    _$hash = $jc(_$hash, latitude.hashCode);
    _$hash = $jc(_$hash, longitude.hashCode);
    _$hash = $jc(_$hash, successful_landings.hashCode);
    _$hash = $jc(_$hash, attempted_landings.hashCode);
    _$hash = $jc(_$hash, mission.hashCode);
    _$hash = $jf(_$hash);
    return _$hash;
  }
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'GShipsFind')
          ..add('id', id)
          ..add('name', name)
          ..add('model', model)
          ..add('type', type)
...
class _$Gusers_bool_exp extends Gusers_bool_exp {
  ...
  @override
  final GString_comparison_exp? rocket;
  @override
  final Gtimestamptz_comparison_exp? timestamp;
  @override
  final GString_comparison_exp? twitter;
...
class Gusers_bool_expBuilder
  ...
  GString_comparison_expBuilder? _rocket;
  GString_comparison_expBuilder get rocket =>
      _$this._rocket ??= new GString_comparison_expBuilder();
  set rocket(GString_comparison_expBuilder? rocket) => _$this._rocket = rocket;

  Gtimestamptz_comparison_expBuilder? _timestamp;
  Gtimestamptz_comparison_expBuilder get timestamp =>
      _$this._timestamp ??= new Gtimestamptz_comparison_expBuilder();
  set timestamp(Gtimestamptz_comparison_expBuilder? timestamp) =>
      _$this._timestamp = timestamp;

  GString_comparison_expBuilder? _twitter;
  GString_comparison_expBuilder get twitter =>
      _$this._twitter ??= new GString_comparison_expBuilder();
  set twitter(GString_comparison_expBuilder? twitter) =>
...
class _$Gusers_insert_input extends Gusers_insert_input {
  ...
  _$Gusers_insert_input._(
      {this.id, this.name, this.rocket, this.timestamp, this.twitter})
      : super._();
...
class Gusers_insert_inputBuilder
  ...
  String? _rocket;
  String? get rocket => _$this._rocket;
  set rocket(String? rocket) => _$this._rocket = rocket;
...
class _$Gusers_max_order_by extends Gusers_max_order_by {
  ...
  @override
  final Gorder_by? rocket;
  @override
  final Gorder_by? timestamp;
  @override
  final Gorder_by? twitter;
  ...
  _$Gusers_max_order_by._(
      {this.name, this.rocket, this.timestamp, this.twitter})
      : super._();
...
class Gusers_max_order_byBuilder
  ...
  Gorder_by? _rocket;
  Gorder_by? get rocket => _$this._rocket;
  set rocket(Gorder_by? rocket) => _$this._rocket = rocket;

  Gorder_by? _timestamp;
  Gorder_by? get timestamp => _$this._timestamp;
  set timestamp(Gorder_by? timestamp) => _$this._timestamp = timestamp;

  Gorder_by? _twitter;
  Gorder_by? get twitter => _$this._twitter;
  set twitter(Gorder_by? twitter) => _$this._twitter = twitter;
  ...
  _$Gusers_max_order_by _build() {
    final _$result = _$v ??
        new _$Gusers_max_order_by._(
            name: name, rocket: rocket, timestamp: timestamp, twitter: twitter);
    replace(_$result);
    return _$result;
  }
}
...
class _$Gusers_on_conflict extends Gusers_on_conflict {
  ...
  _$Gusers_on_conflict._(
      {required this.constraint, required this.update_columns})
      : super._() {
    BuiltValueNullFieldError.checkNotNull(
